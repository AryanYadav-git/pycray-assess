        ...
        <table className="min-w-full table-auto">
          <thead className="bg-gray-50">
            <tr className="">
              ...
              <th className=" text-left text-blue-900">Total Units</th>
              <th className=" text-left text-blue-900">Filled Units</th>
              <th className=" text-left text-blue-900">Vacant Units</th>
              <th className=" text-left text-blue-900">Occupancy Rate</th>
              <th className=" text-left text-blue-900">Last Maintenance Date</th>
            </tr>
          </thead>
          <tbody>
            {data.map((item, index) => (
